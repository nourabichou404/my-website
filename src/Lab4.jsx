...
// -------------------------------
const Search = () => {
  // Step 5 & 7: event handler using arrow function
  const handleChange = (e) => {
    console.log("Event object:", e);           // logs the full event
    console.log("Typed value:", e.target.value); // logs only what the user typed
  };
...
//    - and many other browser-level properties